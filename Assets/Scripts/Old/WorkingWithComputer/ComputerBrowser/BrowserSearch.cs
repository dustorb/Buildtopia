...
public class BrowserSearch : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.Return) && input.text == "BuildTopia баг" 
          || Input.GetKeyDown(KeyCode.Return) && input.text == "buildtopia баг" 
          || Input.GetKeyDown(KeyCode.Return) && input.text == "посмотри на небо" 
          || Input.GetKeyDown(KeyCode.Return) && input.text == "BuildTopia посмотри на небо" 
          || Input.GetKeyDown(KeyCode.Return) && input.text == "buildtopia посмотри на небо" 
          || Input.GetKeyDown(KeyCode.Return) && input.text == "BuildTopia баг небо"
          || Input.GetKeyDown(KeyCode.Return) && input.text == "BuildTopia"
          || Input.GetKeyDown(KeyCode.Return) && input.text == "BuildTopia небо"
          || Input.GetKeyDown(KeyCode.Return) && input.text == "небо"
          || Input.GetKeyDown(KeyCode.Return) && input.text == "buildtopia"
          || Input.GetKeyDown(KeyCode.Return) && input.text == "buildtopia баг"
          || Input.GetKeyDown(KeyCode.Return) && input.text == "buildtopia небо"
          || Input.GetKeyDown(KeyCode.Return) && input.text == "билдтопия небо"
          || Input.GetKeyDown(KeyCode.Return) && input.text == "билдтопия"
          || Input.GetKeyDown(KeyCode.Return) && input.text == "Билдтопия")
        {
