...
public class SearchButton : MonoBehaviour
{
    ...
    public void Search()
    {
        if (input.text == "BuildTopia баг" 
            || input.text == "buildtopia баг"
            || input.text == "buildtopia небо"
            ||  input.text == "посмотри на небо" 
            ||  input.text == "BuildTopia посмотри на небо" 
            ||  input.text == "buildtopia посмотри на небо" 
            || input.text == "BuildTopia баг небо"
            || input.text == "BuildTopia"
            || input.text == "BuildTopia небо"
            || input.text == "небо баг"
            || input.text == "билдтопия небо"
            || input.text == "Билдтопия небо"
            || input.text == "билдтопия"
            || input.text == "билдтопия баг")
        {
